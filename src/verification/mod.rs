//! Formal Verification Suite for `atproto-oauth`.
//!
//! This module provides mathematical specifications, Hoare-logic deductive contracts
//! (compatible with Verus deductive verification), and bounded model checking harnesses
//! (compatible with the Kani Rust Model Checker) with mandatory anti-vacuity reachability gates.
//!
//! ## Verification Architecture
//!
//! The formal verification suite is organized into two foundational layers:
//!
//! 1. **Deductive Contracts & Mathematical Models ([`verus_contracts`])**:
...
//!      invariants proving state transition safety, deterministic bounds, and cryptographic
//!      soundness.
...
//!    - Exhaustive symbolic execution harnesses tagged with `#[cfg_attr(kani, kani::proof)]`.
...
//!
//! | Invariant | Description | Deductive Model | Model Checking Harness |
//! |---|---|---|---|
